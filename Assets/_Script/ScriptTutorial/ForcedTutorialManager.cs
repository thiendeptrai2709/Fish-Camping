...
public enum TutorialStage
{
    ...
    Quest8_FindGasStation,      // NV 8.1: Đi tìm cây xăng -> Bấm F (hoặc Ctrl)
    Quest8_GoToPumpAndBuyGas,   // NV 8.2: Xuống xe đi đến trụ xăng -> Ctrl tiếp tục
...
public class ForcedTutorialManager : MonoBehaviour
{
    ...
    {
        if (questUIPanel == null || instructionTMP == null)
        {
            ...
            if (foundPanel != null)
            {
                ...
                panelRect = questUIPanel.GetComponent<RectTransform>();
                instructionTMP = questUIPanel.GetComponentInChildren<TextMeshProUGUI>();
            }
        }
    ...
    private void Update()
    {
        ...
        if (currentStage == TutorialStage.Completed || Keyboard.current == null) return;
        ...
        {
            if (Keyboard.current.fKey.wasPressedThisFrame || isCtrlPressed)
                AdvanceToStage(TutorialStage.Quest8_GoToPumpAndBuyGas);
        }
        else if (currentStage == TutorialStage.Quest8_GoToPumpAndBuyGas)
        {
            if (isCtrlPressed) AdvanceToStage(TutorialStage.Quest9_OpenTravelMap);
        }
    ...
    private void UpdateQuestUI()
    {
        ...
        if (progressTMP != null)
        {
            int currentNum = (int)currentStage;
            int totalNum = (int)TutorialStage.Completed;
            progressTMP.text = $"HƯỚNG DẪN ({currentNum}/{totalNum})";
        }

        // TẤT CẢ CÁC CHỮ IN ĐẬM ĐÃ ĐƯỢC CHUYỂN THÀNH MÀU TÍM <color=#B388FF><b>...</b></color>
        switch (currentStage)
        {
            ...
            case TutorialStage.Quest1_Movement:
                ...
                currentPromptText = "Nhấn [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Quest5_ShopNPCGuide:
                ...
                currentPromptText = "Nhấn [E] hoặc [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Quest6_InteractUpgradeNPC:
                ...
                currentPromptText = "Nhấn [Z] hoặc [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Quest8_FindGasStation:
                currentInstructionText = "Hãy lái xe đi quanh thị trấn tìm <color=#B388FF><b>Cây Xăng</b></color>.";
                currentPromptText = "Đến gần cây xăng nhấn [F] hoặc [Ctrl]";
                break;
            case TutorialStage.Quest8_GoToPumpAndBuyGas:
                currentInstructionText = "Xuống xe đi đến trụ xăng để mua xăng.";
                currentPromptText = "Nhấn [Ctrl] để tiếp tục";
                break;
            case TutorialStage.Quest9_OpenTravelMap:
                ...
                currentPromptText = "Nhấn [M] hoặc [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Map2_Quest6_KeepOrReleaseFish:
                ...
                currentPromptText = "Nhấn [Space] hoặc [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Map2_Quest8_PlaceFirewood:
                ...
                currentPromptText = "Nhấn [B] hoặc [Ctrl] để tiếp tục";
                break;
            ...
            case TutorialStage.Map2_Quest15_FishLog:
                ...
                currentPromptText = "Nhấn [J] hoặc [Ctrl] để tiếp tục";
                break;
            case TutorialStage.Map2_Quest16_HelpGuide:
                ...
                currentPromptText = "Nhấn [P] hoặc [Ctrl] để hoàn thành";
                break;

            case TutorialStage.Completed:
                currentInstructionText = "Hoàn thành!";
                currentPromptText = "";
                break;
        }
